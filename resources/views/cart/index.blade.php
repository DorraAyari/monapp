        ...
        <div class="container">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row" class="border-0">
                                    <div class="p-2">
                                        <img src="{{ $product->model->pics }}" alt="" width="70" class="img-fluid rounded shadow-sm">
                                        <div class="ml-3 d-inline-block align-middle">
                                            <h5 class="mb-0"> <a href="{{ route('welcome', ['slug' => $product->model->slug]) }}" class="text-dark d-inline-block align-middle">{{ $product->model->produits_nom }}</a></h5><span class="text-muted font-weight-normal font-italic d-block">Category:</span>
                                        </div>
                                    </div>
                                </th>
            ...
            <div class="row py-5 p-4 bg-white rounded shadow-sm">
                    ...
                    <div class="p-4">
                        ...
                        </ul><a href="{{ route('check.index') }}" class="btn btn-dark rounded-pill py-2 btn-block">Passer à la caisse</a>
                    </div>
                    </div>
            </div>
        </div>
