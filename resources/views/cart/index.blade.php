                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row" class="border-0">
                                        <div class="p-2">
                                            <img src="{{ asset('storage/' . $produit->model->pics) }}" alt="" width="70" class="img-fluid rounded shadow-sm">
                                            <div class="ml-3 d-inline-block align-middle">
                                                <h5 class="mb-0"> <a  class="text-dark d-inline-block align-middle">{{ $produit->model->produits_nom }}</a></h5><span class="text-muted font-weight-normal font-italic d-block">Category:</span>
                                            </div>
                                        </div>
                                    </th>
                                    <td class="border-0 align-middle"><strong>{{ ($produit->subtotal()) }}</strong></td>
            ...
            <div class="row p-4 bg-white rounded shadow-sm">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="p-4">
                        ...
                        @endif
                        </ul><a href="{{ route('check.index') }}" class="btn btn-dark rounded-pill py-2 btn-block"><i class="fa fa-credit-card" aria-hidden="true"></i> Passer à la caisse</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="col-md-12">
    ...
    <p>Mais vous pouvez visiter la <a href="{{ route('welcome') }}">boutique</a> pour faire votre shopping.
    </p>
</div>
@endif
